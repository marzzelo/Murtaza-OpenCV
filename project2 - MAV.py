...
widthImg = 1280  #cap.get(3)
heightImg = 960  #cap.get(4)
    ...
    for cnt in contours:
        ...
        if area > 5000:
            ...
            for vertex in approx:
                cv2.circle(imgContour, (vertex[0][0], vertex[0][1]), 20, (0, 255, 0), cv2.FILLED)
...
def reorder(myPoints):
    ...
    myPointsNew = np.zeros((4, 1, 2), np.int32)  # READ AS "4 ROWS BY 1 COLUMN OF 2 ELEMENTS EACH"
...
while True:
    ...
    if biggest.size != 0:
        ...
        cv2.putText(imgWarped, "No contour detected", (50, 50), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 0, 255), 2)
        imageArray = [imgContour, imgWarped]
